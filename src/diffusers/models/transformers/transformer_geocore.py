...
"""GeoCore Flow Matching DiT transformer (FLUX.2-style Diffusers model)."""
...
class GeoCoreTransformer2DModel(Flux2, ModelMixin, ConfigMixin):
    ...
    Architecture follows the FLUX.2 double/single-stream transformer layout with
    additional geospatial metadata conditioning (`res`, `lon`, `lat`).
    """
    ...
    @classmethod
    def from_flux2_params(
        cls, params: GeoCore9BParams | GeoCore4BParams, model_size: str
    ) -> "GeoCoreTransformer2DModel":
